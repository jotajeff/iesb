...
final class AdminRepository
{
    ...
    public function findCarouselById(int $id): ?array
    {
        $pdo = Database::connection();
        if (!$pdo instanceof PDO) {
            return null;
    ...
    public function findCarouselItemsByCarouselId(int $idCarousel): array
    {
        $pdo = Database::connection();
        if (!$pdo instanceof PDO) {
            return [];
    ...
    public function listCarousels(): array
    {
        $pdo = Database::connection();
        if (!$pdo instanceof PDO) {
            return [];
    ...
    public function listCarouselsAtivos(): array
    {
        $pdo = Database::connection();
        if (!$pdo instanceof PDO) {
            return [];
