                ...
                <div class="card border mb-2 shadow-xs">
                  <div class="card-body p-3">
                    ...
                    <div class="small text-muted mb-1">
                      <i class="bi bi-whatsapp me-1" style="color:#128C7E;"></i>
                      <?php if ($wa !== ''): ?>
                        <a href="https://wa.me/<?= $wa ?>" target="_blank" class="text-decoration-none text-muted"><?= htmlspecialchars(\App\Helpers\WhatsAppHelper::format((string) ($p['whatsapp'] ?? '-')), ENT_QUOTES, 'UTF-8') ?></a>
                      <?php else: ?>
