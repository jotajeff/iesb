...
<section class="py-4" id="documentos" style="margin-top: 20px;">
  <div class="container">
    <div class="p-4 rounded-3 shadow-sm" style="background: var(--bg-card); border: 1px solid var(--border-color);">
      ...
      <?php if (!empty($pasta['folder_name'])): ?>
        <div class="alert alert-light border small mb-4">
          ...
          Pasta do aluno: <strong><?= htmlspecialchars((string) $pasta['folder_name'], ENT_QUOTES, 'UTF-8') ?></strong>
        </div>
      <?php endif; ?>
                ...
                <tr>
                  ...
                  <td>
                    <div class="d-flex flex-wrap gap-1">
                      <?php if ($docId > 0): ?>
                        <a class="btn btn-sm btn-outline-success" href="/aluno/documentos/visualizar?id=<?= $docId ?>" target="_blank" title="Visualizar">
                          <i class="bi bi-eye"></i>
                        </a>
                        <a class="btn btn-sm btn-outline-primary" href="/aluno/documentos/baixar?id=<?= $docId ?>" title="Baixar">
                      ...
                      <?php if ($storageConectado): ?>
                        ...
                        <?php if ($docId > 0 && $podeExcluir): ?>
                          <form method="post" action="/aluno/documentos/excluir" class="d-inline" onsubmit="return confirm('Excluir este documento?');">
