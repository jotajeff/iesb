<section class="py-4" style="margin-top: 76px;">
  <div class="container">
    <div class="d-flex align-items-center justify-content-between mb-4" data-aos="fade-up">
      <h4 class="mb-0"><i class="bi bi-camera-reels me-2"></i><?= htmlspecialchars($material['titulo'] ?? 'Vídeo', ENT_QUOTES, 'UTF-8') ?></h4>
      <a class="btn btn-outline-secondary btn-sm" href="#" onclick="history.back();return false;"><i class="bi bi-arrow-left me-1"></i>Voltar</a>
    </div>
