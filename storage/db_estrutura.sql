...
--
-- Host: localhost:3306
-- Tempo de geração: 11/06/2026 às 09:30
...
--
CREATE DATABASE IF NOT EXISTS `vanes415_db` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;
USE `vanes415_db`;
...
CREATE TABLE social (
    ...
    id_fk INT NOT NULL, -- ID do Usuário/Empresa
    tipo VARCHAR(20) NOT NULL, 
    rede VARCHAR(50) NOT NULL,
    link_perfil VARCHAR(255) NOT NULL, -- O link ou @usuario do perfil
    
    CONSTRAINT pk_social PRIMARY KEY (id)
    -- CONSTRAINT fk_social_usuario FOREIGN KEY (id_fk) REFERENCES usuarios(id) ON DELETE CASCADE
);
